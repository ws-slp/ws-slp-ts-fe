...
const AuthPage: NextPage<NextAppPageProps> = () => {
  ...
  const handleSubmit = (event: React.FormEvent) => {
    ...
    // TODO: Resolve issue with object invocation returning undefined on signIn/signUp; remove bang operator
        ...
        <form className="w-full sm:w-1/2 xl:w-1/3" onSubmit={handleSubmit}>
          <div className="border-teal p-8 border-t-12 bg-white mb-6 rounded-lg shadow-lg">
            <button
              onClick={evt => {
                evt.preventDefault();
                // TODO: Resolve issue with object invocation returning undefined on signInWithProvider; remove bang operator
